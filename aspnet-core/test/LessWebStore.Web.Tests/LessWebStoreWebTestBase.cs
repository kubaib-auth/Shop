...
{
    public abstract class LessWebStoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LessWebStoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LessWebStoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LessWebStoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LessWebStoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LessWebStoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LessWebStoreDbContext, Task<T>> func)
        {
            T result;
