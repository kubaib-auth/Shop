...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            new MenuItem(this.l('Home'), '/app/about', 'fas fa-info-circle'),
            new MenuItem(this.l('About'), '/app/home', 'fas fa-home'),
            ...
            new MenuItem(
                this.l('Asign Student Course list'),
                '/app/asign-course-List',
                'fas fa-book-open',
                'Pages.Users'
            ),
